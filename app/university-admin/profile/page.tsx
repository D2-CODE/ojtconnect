  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">Keep your university information up to date.</p>
      </div>

      <div className="bg-white rounded-2xl border border-gray-200 p-6 flex flex-col gap-4">
        <Input label="University Name" value={form.name} onChange={(e) => set('name', e.target.value)} placeholder="University of the Philippines" />
        ...
        <div>
          ...
          <textarea className="w-full border border-gray-300 rounded-xl px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#0F6E56] resize-none" rows={3}
            value={form.description} onChange={(e) => set('description', e.target.value)} placeholder="Brief university description..." />
        </div>
        <Input label="Contact Email" type="email" value={form.contactEmail} onChange={(e) => set('contactEmail', e.target.value)} placeholder="ojtcoordinator@university.edu.ph" />
