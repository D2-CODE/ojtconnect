      ...
      <section className="py-20 px-5 bg-gray-50">
        <div className="max-w-[1440px] mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">Whether you&apos;re a student, company, or school, OJT Connect PH has you covered.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: GraduationCap, title: 'Students', color: 'bg-blue-50 text-blue-600', desc: 'Browse real leads, claim your Facebook post, get School-verified, and connect with companies directly.', cta: 'Sign up as student', href: '/register' },
              ...
              { icon: University, title: 'Schools', color: 'bg-purple-50 text-purple-600', desc: 'Verify your students, track their OJT placements, and maintain your institution&apos;s reputation.', cta: 'Register school', href: '/register' },
      ...
      <section className="py-20 px-5 bg-white">
        <div className="max-w-[1440px] mx-auto">
          <div className="flex items-end justify-between mb-10">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Partner Schools</h2>
