  ...
  const handleClaim = async () => {
    ...
    try {
      ...
      if (d.success) {
        ...
        const fallback = claimData?.leadType === 'intern' ? '/student/dashboard' : '/company/dashboard';
    ...
    <>
      ...
      {state === 'success' && (
        <div className="text-center py-4">
          ...
          <Button onClick={() => router.push(claimData?.leadType === 'intern' ? '/student/dashboard' : '/company/dashboard')} className="w-full">
            Go to Dashboard
          </Button>
        </div>
      )}
